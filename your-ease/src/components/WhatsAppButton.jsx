...
const WhatsAppButton = () => {
  const phoneNumber = '923421262609';
  const message = "Hello! I'm interested in your products. Can you help me?";

  const handleClick = () => {
    // Try to open WhatsApp app first (works on both mobile and desktop if app is installed)
    ...
    const timeout = setTimeout(() => {
      if (!appOpened) {
        // If app didn't open, fallback to WhatsApp Web
